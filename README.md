...
MY_DEVELOPER_TOKEN
The app should provide the developer token while initializing the SDK. Get it from AllCloud Advertising Account Manager.
MY_ORGANIZATION
The app should provide the organization while initializing the SDK. Get it from AllCloud Advertising Account Manager.
Monitoring Regions
...
3.	Initialize NearBee using one-line initialization, the initialization starts scanning for beacons immediately.
